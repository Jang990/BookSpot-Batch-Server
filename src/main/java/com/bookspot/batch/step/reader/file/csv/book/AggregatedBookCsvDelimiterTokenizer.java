...
public class AggregatedBookCsvDelimiterTokenizer implements LineTokenizer {
    private static final char QUOTE = '"';
    private static final String[] fieldNames = Arrays.stream(AggregatedBooksCsvSpec.values())
