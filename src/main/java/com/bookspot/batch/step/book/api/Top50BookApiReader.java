...
public class Top50BookApiReader implements ItemReader<Top50BookStrings> {
    private final LocalDate referenceDate;
    private final RankingConditions rankingConditions;
    private final WeeklyTop50ApiRequester weeklyTop50ApiRequester;

    private List<Top50BookStrings> result;
    private int currentIndex;

    @Override
    public Top50BookStrings read() throws Exception, UnexpectedInputException, ParseException, NonTransientResourceException {
        if(result == null)
