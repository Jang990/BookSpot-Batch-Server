...
CREATE TABLE BATCH_STEP_EXECUTION_SEQ (
    ...
    constraint UNIQUE_KEY_UN_STEP unique (UNIQUE_KEY)  -- 이름 변경
) ENGINE=InnoDB;
...
CREATE TABLE BATCH_JOB_EXECUTION_SEQ (
    ID BIGINT NOT NULL,
    UNIQUE_KEY CHAR(1) NOT NULL,
    constraint UNIQUE_KEY_UN_JOB_EXEC unique (UNIQUE_KEY) -- 이름 변경
) ENGINE=InnoDB;
...
CREATE TABLE BATCH_JOB_SEQ (
    ID BIGINT NOT NULL,
    UNIQUE_KEY CHAR(1) NOT NULL,
    constraint UNIQUE_KEY_UN_JOB unique (UNIQUE_KEY) -- 이름 변경
) ENGINE=InnoDB;
